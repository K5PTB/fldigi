...
static void cb_listbox_contest(Fl_ListBox* o, void*) {
  ...
  if (index < 0)
    return;
  for (int i = 0; ; i++) {
    if (contests[i].name.empty())
      return;
    if (i == index)
      break;
  }
  progdefaults.logging = index;
...
static void cb_listbox_QP_contests(Fl_ListBox* o, void*) {
  int n = o->index();
  if (progdefaults.logging < 0 || contests[progdefaults.logging].name.empty())
    return;
...
Fl_Group *grpContestDetails=(Fl_Group *)0;

Fl_Input2 *inpContestCall=(Fl_Input2 *)0;

static void cb_inpContestCall(Fl_Input2* o, void*) {
  progdefaults.contestCall = o->value();
  progdefaults.changed = true;
}

Fl_Input2 *inpContestOperators=(Fl_Input2 *)0;

static void cb_inpContestOperators(Fl_Input2* o, void*) {
  progdefaults.contestOperators = o->value();
  progdefaults.changed = true;
}

Fl_Input2 *inpContestLocator=(Fl_Input2 *)0;

static void cb_inpContestLocator(Fl_Input2* o, void*) {
  progdefaults.contestLocator = o->value();
  progdefaults.changed = true;
}

Fl_Input2 *inpContestClub=(Fl_Input2 *)0;

static void cb_inpContestClub(Fl_Input2* o, void*) {
  progdefaults.contestClub = o->value();
  progdefaults.changed = true;
}

Fl_Input2 *inpContestName=(Fl_Input2 *)0;

static void cb_inpContestName(Fl_Input2* o, void*) {
  progdefaults.contestName = o->value();
  progdefaults.changed = true;
}

Fl_Input2 *inpContestAddress=(Fl_Input2 *)0;

static void cb_inpContestAddress(Fl_Input2* o, void*) {
  progdefaults.contestAddress = o->value();
  progdefaults.changed = true;
}

Fl_Input2 *inpContestCity=(Fl_Input2 *)0;

static void cb_inpContestCity(Fl_Input2* o, void*) {
  progdefaults.contestCity = o->value();
  progdefaults.changed = true;
}

Fl_Input2 *inpContestPostalCode=(Fl_Input2 *)0;

static void cb_inpContestPostalCode(Fl_Input2* o, void*) {
  progdefaults.contestPostalCode = o->value();
  progdefaults.changed = true;
}

Fl_Input2 *inpContestEmail=(Fl_Input2 *)0;

static void cb_inpContestEmail(Fl_Input2* o, void*) {
  progdefaults.contestEmail = o->value();
  progdefaults.changed = true;
}

Fl_Input2 *inpContestDarcDok=(Fl_Input2 *)0;

static void cb_inpContestDarcDok(Fl_Input2* o, void*) {
  progdefaults.contestDarcDok = o->value();
  progdefaults.changed = true;
}

Fl_Input2 *inpContestSoapbox=(Fl_Input2 *)0;

static void cb_inpContestSoapbox(Fl_Input2* o, void*) {
  progdefaults.contestSoapbox = o->value();
  progdefaults.changed = true;
}

Fl_Choice *choiceContestOperator=(Fl_Choice *)0;

static void cb_choiceContestOperator(Fl_Choice* o, void*) {
  progdefaults.contestOperator = o->value();
  progdefaults.changed = true;
}

Fl_Choice *choiceContestTransmitter=(Fl_Choice *)0;

static void cb_choiceContestTransmitter(Fl_Choice* o, void*) {
  progdefaults.contestTransmitter = o->value();
  progdefaults.changed = true;
}

Fl_Choice *choiceContestAssisted=(Fl_Choice *)0;

static void cb_choiceContestAssisted(Fl_Choice* o, void*) {
  progdefaults.contestAssisted = o->value();
  progdefaults.changed = true;
}

Fl_Choice *choiceContestBand=(Fl_Choice *)0;

static void cb_choiceContestBand(Fl_Choice* o, void*) {
  progdefaults.contestBand = o->value();
  progdefaults.changed = true;
}

Fl_Choice *choiceContestPower=(Fl_Choice *)0;

static void cb_choiceContestPower(Fl_Choice* o, void*) {
  progdefaults.contestPower = o->value();
  progdefaults.changed = true;
}

Fl_Choice *choiceContestMode=(Fl_Choice *)0;

static void cb_choiceContestMode(Fl_Choice* o, void*) {
  progdefaults.contestMode = o->value();
  progdefaults.changed = true;
}

Fl_Choice *choiceContestStation=(Fl_Choice *)0;

static void cb_choiceContestStation(Fl_Choice* o, void*) {
  progdefaults.contestStation = o->value();
  progdefaults.changed = true;
}
...
Fl_Double_Window* ConfigureDialog() {
  ...
  { Fl_Double_Window* o = new Fl_Double_Window(801, 380, gettext("Fldigi configuration"));
    ...
    { Fl_Group* o = grpContestDetails = new Fl_Group(200, 0, 600, 350, gettext("Contests/Info"));
      grpContestDetails->box(FL_ENGRAVED_BOX);
      grpContestDetails->color(FL_LIGHT1);
      grpContestDetails->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
      grpContestDetails->hide();
      { Fl_Input2* o = inpContestCall = new Fl_Input2(386, 35, 320, 24, gettext("Contest Call:"));
        inpContestCall->tooltip(gettext("Contest callsign"));
        inpContestCall->box(FL_DOWN_BOX);
        inpContestCall->color(FL_BACKGROUND2_COLOR);
        inpContestCall->selection_color(FL_SELECTION_COLOR);
        inpContestCall->labeltype(FL_NORMAL_LABEL);
        inpContestCall->labelfont(0);
        inpContestCall->labelsize(14);
        inpContestCall->labelcolor(FL_FOREGROUND_COLOR);
        inpContestCall->callback((Fl_Callback*)cb_inpContestCall);
        inpContestCall->align(Fl_Align(FL_ALIGN_LEFT));
        inpContestCall->when(FL_WHEN_RELEASE);
        o->labelsize(FL_NORMAL_SIZE);
        o->value(progdefaults.contestCall.c_str());
      } // Fl_Input2* inpContestCall
      { Fl_Input2* o = inpContestOperators = new Fl_Input2(386, 63, 320, 24, gettext("Operators:"));
        inpContestOperators->tooltip(gettext("Contest operators"));
        inpContestOperators->box(FL_DOWN_BOX);
        inpContestOperators->color(FL_BACKGROUND2_COLOR);
        inpContestOperators->selection_color(FL_SELECTION_COLOR);
        inpContestOperators->labeltype(FL_NORMAL_LABEL);
        inpContestOperators->labelfont(0);
        inpContestOperators->labelsize(14);
        inpContestOperators->labelcolor(FL_FOREGROUND_COLOR);
        inpContestOperators->callback((Fl_Callback*)cb_inpContestOperators);
        inpContestOperators->align(Fl_Align(FL_ALIGN_LEFT));
        inpContestOperators->when(FL_WHEN_RELEASE);
        o->labelsize(FL_NORMAL_SIZE);
        o->value(progdefaults.contestOperators.c_str());
      } // Fl_Input2* inpContestOperators
      { Fl_Input2* o = inpContestLocator = new Fl_Input2(386, 91, 320, 24, gettext("Locator:"));
        inpContestLocator->tooltip(gettext("Contest locator"));
        inpContestLocator->box(FL_DOWN_BOX);
        inpContestLocator->color(FL_BACKGROUND2_COLOR);
        inpContestLocator->selection_color(FL_SELECTION_COLOR);
        inpContestLocator->labeltype(FL_NORMAL_LABEL);
        inpContestLocator->labelfont(0);
        inpContestLocator->labelsize(14);
        inpContestLocator->labelcolor(FL_FOREGROUND_COLOR);
        inpContestLocator->callback((Fl_Callback*)cb_inpContestLocator);
        inpContestLocator->align(Fl_Align(FL_ALIGN_LEFT));
        inpContestLocator->when(FL_WHEN_RELEASE);
        o->labelsize(FL_NORMAL_SIZE);
        o->value(progdefaults.contestLocator.c_str());
      } // Fl_Input2* inpContestLocator
      { Fl_Input2* o = inpContestClub = new Fl_Input2(386, 119, 320, 24, gettext("Club:"));
        inpContestClub->tooltip(gettext("Contest club"));
        inpContestClub->box(FL_DOWN_BOX);
        inpContestClub->color(FL_BACKGROUND2_COLOR);
        inpContestClub->selection_color(FL_SELECTION_COLOR);
        inpContestClub->labeltype(FL_NORMAL_LABEL);
        inpContestClub->labelfont(0);
        inpContestClub->labelsize(14);
        inpContestClub->labelcolor(FL_FOREGROUND_COLOR);
        inpContestClub->callback((Fl_Callback*)cb_inpContestClub);
        inpContestClub->align(Fl_Align(FL_ALIGN_LEFT));
        inpContestClub->when(FL_WHEN_RELEASE);
        o->labelsize(FL_NORMAL_SIZE);
        o->value(progdefaults.contestClub.c_str());
      } // Fl_Input2* inpContestClub
      { Fl_Input2* o = inpContestName = new Fl_Input2(386, 147, 320, 24, gettext("Name:"));
        inpContestName->tooltip(gettext("Contest operator name"));
        inpContestName->box(FL_DOWN_BOX);
        inpContestName->color(FL_BACKGROUND2_COLOR);
        inpContestName->selection_color(FL_SELECTION_COLOR);
        inpContestName->labeltype(FL_NORMAL_LABEL);
        inpContestName->labelfont(0);
        inpContestName->labelsize(14);
        inpContestName->labelcolor(FL_FOREGROUND_COLOR);
        inpContestName->callback((Fl_Callback*)cb_inpContestName);
        inpContestName->align(Fl_Align(FL_ALIGN_LEFT));
        inpContestName->when(FL_WHEN_RELEASE);
        o->labelsize(FL_NORMAL_SIZE);
        o->value(progdefaults.contestName.c_str());
      } // Fl_Input2* inpContestName
      { Fl_Input2* o = inpContestAddress = new Fl_Input2(386, 175, 320, 24, gettext("Address:"));
        inpContestAddress->tooltip(gettext("Contest address"));
        inpContestAddress->box(FL_DOWN_BOX);
        inpContestAddress->color(FL_BACKGROUND2_COLOR);
        inpContestAddress->selection_color(FL_SELECTION_COLOR);
        inpContestAddress->labeltype(FL_NORMAL_LABEL);
        inpContestAddress->labelfont(0);
        inpContestAddress->labelsize(14);
        inpContestAddress->labelcolor(FL_FOREGROUND_COLOR);
        inpContestAddress->callback((Fl_Callback*)cb_inpContestAddress);
        inpContestAddress->align(Fl_Align(FL_ALIGN_LEFT));
        inpContestAddress->when(FL_WHEN_RELEASE);
        o->labelsize(FL_NORMAL_SIZE);
        o->value(progdefaults.contestAddress.c_str());
      } // Fl_Input2* inpContestAddress
      { Fl_Input2* o = inpContestCity = new Fl_Input2(386, 203, 320, 24, gettext("City:"));
        inpContestCity->tooltip(gettext("Contest city"));
        inpContestCity->box(FL_DOWN_BOX);
        inpContestCity->color(FL_BACKGROUND2_COLOR);
        inpContestCity->selection_color(FL_SELECTION_COLOR);
        inpContestCity->labeltype(FL_NORMAL_LABEL);
        inpContestCity->labelfont(0);
        inpContestCity->labelsize(14);
        inpContestCity->labelcolor(FL_FOREGROUND_COLOR);
        inpContestCity->callback((Fl_Callback*)cb_inpContestCity);
        inpContestCity->align(Fl_Align(FL_ALIGN_LEFT));
        inpContestCity->when(FL_WHEN_RELEASE);
        o->labelsize(FL_NORMAL_SIZE);
        o->value(progdefaults.contestCity.c_str());
      } // Fl_Input2* inpContestCity
      { Fl_Input2* o = inpContestPostalCode = new Fl_Input2(386, 231, 320, 24, gettext("Postalcode:"));
        inpContestPostalCode->tooltip(gettext("Contest postal code"));
        inpContestPostalCode->box(FL_DOWN_BOX);
        inpContestPostalCode->color(FL_BACKGROUND2_COLOR);
        inpContestPostalCode->selection_color(FL_SELECTION_COLOR);
        inpContestPostalCode->labeltype(FL_NORMAL_LABEL);
        inpContestPostalCode->labelfont(0);
        inpContestPostalCode->labelsize(14);
        inpContestPostalCode->labelcolor(FL_FOREGROUND_COLOR);
        inpContestPostalCode->callback((Fl_Callback*)cb_inpContestPostalCode);
        inpContestPostalCode->align(Fl_Align(FL_ALIGN_LEFT));
        inpContestPostalCode->when(FL_WHEN_RELEASE);
        o->labelsize(FL_NORMAL_SIZE);
        o->value(progdefaults.contestPostalCode.c_str());
      } // Fl_Input2* inpContestPostalCode
      { Fl_Input2* o = inpContestEmail = new Fl_Input2(386, 259, 320, 24, gettext("eMail:"));
        inpContestEmail->tooltip(gettext("Contest email address"));
        inpContestEmail->box(FL_DOWN_BOX);
        inpContestEmail->color(FL_BACKGROUND2_COLOR);
        inpContestEmail->selection_color(FL_SELECTION_COLOR);
        inpContestEmail->labeltype(FL_NORMAL_LABEL);
        inpContestEmail->labelfont(0);
        inpContestEmail->labelsize(14);
        inpContestEmail->labelcolor(FL_FOREGROUND_COLOR);
        inpContestEmail->callback((Fl_Callback*)cb_inpContestEmail);
        inpContestEmail->align(Fl_Align(FL_ALIGN_LEFT));
        inpContestEmail->when(FL_WHEN_RELEASE);
        o->labelsize(FL_NORMAL_SIZE);
        o->value(progdefaults.contestEmail.c_str());
      } // Fl_Input2* inpContestEmail
      { Fl_Input2* o = inpContestDarcDok = new Fl_Input2(386, 287, 320, 24, gettext("DARC DOK:"));
        inpContestDarcDok->tooltip(gettext("Contest DARC DOK"));
        inpContestDarcDok->box(FL_DOWN_BOX);
        inpContestDarcDok->color(FL_BACKGROUND2_COLOR);
        inpContestDarcDok->selection_color(FL_SELECTION_COLOR);
        inpContestDarcDok->labeltype(FL_NORMAL_LABEL);
        inpContestDarcDok->labelfont(0);
        inpContestDarcDok->labelsize(14);
        inpContestDarcDok->labelcolor(FL_FOREGROUND_COLOR);
        inpContestDarcDok->callback((Fl_Callback*)cb_inpContestDarcDok);
        inpContestDarcDok->align(Fl_Align(FL_ALIGN_LEFT));
        inpContestDarcDok->when(FL_WHEN_RELEASE);
        o->labelsize(FL_NORMAL_SIZE);
        o->value(progdefaults.contestDarcDok.c_str());
      } // Fl_Input2* inpContestDarcDok
      { Fl_Input2* o = inpContestSoapbox = new Fl_Input2(386, 315, 320, 24, gettext("SOAPBOX:"));
        inpContestSoapbox->tooltip(gettext("Contest soapbox"));
        inpContestSoapbox->box(FL_DOWN_BOX);
        inpContestSoapbox->color(FL_BACKGROUND2_COLOR);
        inpContestSoapbox->selection_color(FL_SELECTION_COLOR);
        inpContestSoapbox->labeltype(FL_NORMAL_LABEL);
        inpContestSoapbox->labelfont(0);
        inpContestSoapbox->labelsize(14);
        inpContestSoapbox->labelcolor(FL_FOREGROUND_COLOR);
        inpContestSoapbox->callback((Fl_Callback*)cb_inpContestSoapbox);
        inpContestSoapbox->align(Fl_Align(FL_ALIGN_LEFT));
        inpContestSoapbox->when(FL_WHEN_RELEASE);
        o->labelsize(FL_NORMAL_SIZE);
        o->value(progdefaults.contestSoapbox.c_str());
      } // Fl_Input2* inpContestSoapbox
      CONFIG_PAGE *p = new CONFIG_PAGE(o, _("Contests/Info"));
      config_pages.push_back(p);
      tab_tree->add(_("Contests/Info"));
      grpContestDetails->end();
    } // Fl_Group* grpContestDetails
    { Fl_Group* o = new Fl_Group(200, 0, 600, 350, gettext("Contests/Categories"));
      o->box(FL_ENGRAVED_BOX);
      o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
      o->hide();
      { Fl_Choice* o = choiceContestOperator = new Fl_Choice(386, 53, 320, 24, gettext("CATEGORY-OPERATOR:"));
        choiceContestOperator->tooltip(gettext("Contest operator category"));
        choiceContestOperator->down_box(FL_BORDER_BOX);
        choiceContestOperator->callback((Fl_Callback*)cb_choiceContestOperator);
        o->add("CHECKLOG|MULTI-OP|SINGLE-OP");
        o->value(progdefaults.contestOperator);
      } // Fl_Choice* choiceContestOperator
      { Fl_Choice* o = choiceContestTransmitter = new Fl_Choice(386, 84, 320, 24, gettext("CATEGORY-TRANSMITTER:"));
        choiceContestTransmitter->tooltip(gettext("Contest transmitter category"));
        choiceContestTransmitter->down_box(FL_BORDER_BOX);
        choiceContestTransmitter->callback((Fl_Callback*)cb_choiceContestTransmitter);
        o->add("LIMITED|ONE|SWL|TWO|UNLIMITED");
        o->value(progdefaults.contestTransmitter);
      } // Fl_Choice* choiceContestTransmitter
      { Fl_Choice* o = choiceContestAssisted = new Fl_Choice(386, 115, 320, 24, gettext("CATEGORY-ASSISTED:"));
        choiceContestAssisted->tooltip(gettext("Contest assisted category"));
        choiceContestAssisted->down_box(FL_BORDER_BOX);
        choiceContestAssisted->callback((Fl_Callback*)cb_choiceContestAssisted);
        o->add("ASSISTED|NON-ASSISTED");
        o->value(progdefaults.contestAssisted);
      } // Fl_Choice* choiceContestAssisted
      { Fl_Choice* o = choiceContestBand = new Fl_Choice(386, 146, 320, 24, gettext("CATEGORY-BAND:"));
        choiceContestBand->tooltip(gettext("Contest band category"));
        choiceContestBand->down_box(FL_BORDER_BOX);
        choiceContestBand->callback((Fl_Callback*)cb_choiceContestBand);
        o->add("ALL|160M|80M|40M|20M|15M|10M|6M|4M|2M|222|432|902|1.2G|2.3G|3.4G|5.7G|10G|24G|47G|75G|122G|134G|Light|VHF-3-BAND|VHF-FM-ONLY");
        o->value(progdefaults.contestBand);
      } // Fl_Choice* choiceContestBand
      { Fl_Choice* o = choiceContestPower = new Fl_Choice(386, 177, 320, 24, gettext("CATEGORY-POWER:"));
        choiceContestPower->tooltip(gettext("Contest power category"));
        choiceContestPower->down_box(FL_BORDER_BOX);
        choiceContestPower->callback((Fl_Callback*)cb_choiceContestPower);
        o->add("HIGH|LOW|QRP");
        o->value(progdefaults.contestPower);
      } // Fl_Choice* choiceContestPower
      { Fl_Choice* o = choiceContestMode = new Fl_Choice(386, 208, 320, 24, gettext("CATEGORY-MODE:"));
        choiceContestMode->tooltip(gettext("Contest mode category"));
        choiceContestMode->down_box(FL_BORDER_BOX);
        choiceContestMode->callback((Fl_Callback*)cb_choiceContestMode);
        o->add("CW|DIGI|FM|MIXED|RTTY|SSB");
        o->value(progdefaults.contestMode);
      } // Fl_Choice* choiceContestMode
      { Fl_Choice* o = choiceContestStation = new Fl_Choice(386, 239, 320, 24, gettext("CATEGORY-STATION:"));
        choiceContestStation->tooltip(gettext("Contest station category"));
        choiceContestStation->down_box(FL_BORDER_BOX);
        choiceContestStation->callback((Fl_Callback*)cb_choiceContestStation);
        o->add("DISTRIBUTED|EXPEDITION|EXPLORER|FIXED|HQ|MOBILE|PORTABLE|ROVER|ROVER-LIMITED|ROVER-UNLIMITED|SCHOOL");
        o->value(progdefaults.contestStation);
      } // Fl_Choice* choiceContestStation
      CONFIG_PAGE *p = new CONFIG_PAGE(o, _("Contests/Categories"));
      config_pages.push_back(p);
      tab_tree->add(_("Contests/Categories"));
      o->end();
    } // Fl_Group* o
...
"ency"));
      ...
      { Fl_Group* o = new Fl_Group(202, 240, 595, 104, gettext("RTTY Bell"));
        o->box(FL_ENGRAVED_FRAME);
        o->align(Fl_Align(FL_ALIGN_TOP_LEFT|FL_ALIGN_INSIDE));
        { Fl_Check_Button* o = chk_audibleBELL = new Fl_Check_Button(264, 259, 120, 22, gettext("Audible BELL"));
...
"localhost"));
      ...
      { Fl_Group* o = new Fl_Group(209, 237, 580, 66, gettext("TCI receiver  (rig control AND audio)"));
        ...
        { menuTciRx = new Fl_Choice(344, 273, 230, 24, gettext("Rig"));
          menuTciRx->tooltip(gettext("Which TCI receiver fldigi controls. Selects the receiver for rig control AND "
"audio -- they are always the same receiver, so a logged QSO can never carry a "
"different receiver\'s frequency. Entries the radio does not have are greyed."));
    ...
    { Fl_Group* o = grpSoundDevices = new Fl_Group(200, -4, 600, 350, gettext("Soundcard/Devices"));
      ...
      { Fl_Group* o = new Fl_Group(255, 116, 530, 32);
        ...
        { btnAudioIO[4] = new Fl_Round_Button(267, 120, 90, 25, gettext("TCI"));
          btnAudioIO[4]->tooltip(gettext("Get RX/TX audio over the TCI connection (Rig Control/TCI tab) instead of a so"
"undcard -- no driver needed"));
          btnAudioIO[4]->down_box(FL_DOWN_BOX);
          btnAudioIO[4]->callback((Fl_Callback*)cb_btnAudioIO3);
