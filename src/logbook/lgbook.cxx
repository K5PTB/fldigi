...
Fl_Button *bClearLogbook=(Fl_Button *)0;
...
void create_logbook_dialogs() {
  ...
  { Fl_Double_Window* o = dlgLogbook = new Fl_Double_Window(590, 390, gettext("Logbook"));
    ...
    { Fl_Group* o = grpFileButtons = new Fl_Group(0, 262, 589, 25);
      { bNewSave = new Fl_Button(348, 263, 59, 22, gettext("New"));
      ...
      { bUpdateCancel = new Fl_Button(411, 263, 59, 22, gettext("Update"));
      ...
      { bDelete = new Fl_Button(474, 263, 59, 22, gettext("Delete"));
      ...
      { bClearLogbook = new Fl_Button(537, 263, 50, 22, gettext("Clear"));
        bClearLogbook->tooltip(gettext("Clear all records from the current logbook"));
        bClearLogbook->color(FL_LIGHT1);
        bClearLogbook->selection_color((Fl_Color)48);
        bClearLogbook->callback((Fl_Callback*)cb_btnClearLogbook);
      } // Fl_Button* bClearLogbook
      { txtLogFile = new Fl_Output(35, 263, 309, 22, gettext("File:"));
